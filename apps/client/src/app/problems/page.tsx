...
export default async function ProblemsPage({ searchParams }: ProblemsPageProps) {
    ...
    return (
        <main className="mx-auto max-w-screen px-2 sm:px-4 md:px-8 flex flex-col gap-4 mt-12">
            <header className="flex justify-between items-center">
                <h1 className="text-xl md:text-2xl lg:text-3xl font-medium tracking-wide">Problems</h1>
                <ListLayout />
            </header>
